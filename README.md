...
- name: Llama-3.2-3B-Instruct
  ...
  - task:
    ...
    source:
      url: https://huggingface.co/spaces/open-llm-leaderboard/open_llm_leaderboard?query=meta-llama/Llama-3.2-3B-Instruct
...
Detailed results can be found [here](https://huggingface.co/datasets/open-llm-leaderboard/details_meta-llama__Llama-3.2-3B-Instruct)
